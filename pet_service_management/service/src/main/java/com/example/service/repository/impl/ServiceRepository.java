...
import com.example.service.repository.BaseServiceRepository;
...
public class ServiceRepository implements IServiceRepository {
    ...
    public void insertService(Service service) throws SQLException {
        try (Connection connection = BaseServiceRepository.getConnectDB()) {
    ...
    public boolean deleteService(int id) throws SQLException {
        boolean rowDeleted;
        Connection connection = BaseServiceRepository.getConnectDB();
        try {
    ...
    public boolean updateService(Service service) throws SQLException {
        boolean rowUpdated;
        try (Connection connection = BaseServiceRepository.getConnectDB(); PreparedStatement statement = connection.prepareStatement(UPDATE_USERS_SQL);) {
