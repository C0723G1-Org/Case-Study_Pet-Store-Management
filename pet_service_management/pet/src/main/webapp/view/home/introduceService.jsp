...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
  ...
  <div style="height: 60px;background: #e18aaa;font-family: system-ui;" class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <button style="position: relative;left: 2%;border: none;background: #e18aaa;height: 58px;width: 70px;" type="button" onclick="window.open('https://dtruyen.com/tay-du-ky/')"><i class="fa fa-angle-double-left" style="font-size: 48px;color: black;position: relative;left: 2%;"></i><br>
    </button>
    ...
    <h5 style="text-align: center;
            ...
            font-size: -webkit-xxx-large;">HỆ THỐNG CỬA HÀNG THÚ CƯNG PET CARE </h5>

  </div>
  <!-- div cho đòng thứ 2: nội dung giới thiệu pet -->
  <div style="flex-wrap: wrap;background: #efcfd4;" class="col-sm-12 col-md-12 col-lg-12 d-flex">
    <div class="col-lg-6">
    ...
    <div class="col-lg-6 ">
      <div style="    margin: 46px;border-radius: 44px;position: relative;top: 42px;border: solid 7px;box-shadow: 0px 10px 20px 5px rgba(0, 0, 0, 0.5);transform: translateY(-5px);">
  ...
  <div style="padding: 48px;background: #efcfd4;height: 2262px;" class="col-sm-12 col-md-12 col-lg-12">
    <div class="col-sm-12 col-md-12 col-lg-12">
      <div style="text-align: center;" class="col-sm-12 col-md-12 col-lg-12">
        <div style="background-color: #fce4e3;border-radius: 28px;height: auto;margin: 5%;border: solid 5px;box-shadow: 0px 10px 20px 5px rgba(0, 0, 0, 0.5);transform: translateY(-5px);">
          ...
          <div style="box-shadow: 0px 10px 20px 5px rgba(0, 0, 0, 0.5);transform: translateY(-5px);" class="col-sm-12 col-md-12 col-lg-12 d-flex">
            <div style="margin: 0.5%;border-radius: 18px;background: #b7b1b1;">
            ...
            <div style="margin: 0.5%;border-radius: 18px;background: #9ebad3;">
            ...
            <div style="margin: 0.5%;border-radius: 18px;background: #5d8b97;">
      ...
      <div style="height: 200px;" id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carousel">
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="imgpet/gioithieupet_img1.png" class="d-block w-100" alt="...">
          </div>
          <div class="carousel-item">
            <img src="imgpet/gioithieupet_img2.png" class="d-block w-100" alt="...">
          </div>
          <div class="carousel-item">
            <img src="imgpet/gioithieupet_img3.png" class="d-block w-100" alt="...">
          </div>
        </div>
