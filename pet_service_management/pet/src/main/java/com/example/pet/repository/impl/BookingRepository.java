...
public class BookingRepository implements IBookingRepository {
    ...
    public boolean deleteBooking(int id) throws SQLException {
        boolean rowDeleted;
        try (Connection connection = BasePetRepository.getConnectDB(); PreparedStatement statement = connection.prepareStatement(UPDATE_BOOKING_FOR_DELETING);) {
    ...
    public boolean updateBooking(Booking booking) throws SQLException {
        boolean rowUpdated;
        try (Connection connection = BasePetRepository.getConnectDB(); PreparedStatement statement = connection.prepareStatement(UPDATE_BOOKING);) {
