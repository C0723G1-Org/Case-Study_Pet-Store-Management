...
import com.example.pet.model.Service;
import com.example.pet.service.IServiceService;
import com.example.pet.service.impl.ServiceService;
...
public class ServiceServlet extends HttpServlet {
    ...
    private void deleteService(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException, SQLException {
    ...
    private void updateService(HttpServletRequest req, HttpServletResponse resp) throws SQLException, ServletException, IOException {
        int id = Integer.parseInt(req.getParameter("id"));
        String name = req.getParameter("name");
