...
import com.example.pet.repository.IServiceRepository;
...
public class ServiceRepository implements IServiceRepository {
    ...
    public boolean updateService(Service service) throws SQLException {
        boolean rowUpdated;
        try (Connection connection = BasePetRepository.getConnectDB(); PreparedStatement statement = connection.prepareStatement(UPDATE_USERS_SQL);) {
